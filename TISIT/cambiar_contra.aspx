<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cambiar_contra.aspx.cs" Inherits="TISIT.cambiar_contra" %>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <asp:TextBox ID="txtcontra" TextMode="Password" placheholder="Contraseña" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Confirmar Contraseña</label>
                                                </div>
                                                <div class="col-md-8 form-group">
                                                    <asp:TextBox ID="txtconfirmar" TextMode="Password" placheholder="Confirmar Contraseña" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
