<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="requisicion_hospital.aspx.cs" Inherits="TISIT.requisicion_hospital" %>
    ...
    <script>
        ...
        function alertaError() {
            Swal.fire({
                ...
                text: 'LA CANTIDAD PEDIDA ES MAYOR A LA QUE SE PUEDE PEDIR',
            })
        }
        ...
        function alertaReq() {
            Swal.fire({
                icon: 'error',
                title: 'NO SE PUDO AGREGAR LA REQUISICION',
                text: '',
            })
        }
                ...
                <div class="container">
                    <div class="card card-body" id="consultaempleados" runat="server">
                        ...
                        <div class="row gap-1" style="align-items: center; margin: 10px;">
                            <div class="col-lg" runat="server" id="no_contrato">
                                <label class="visually">N° FOLIO</label>
                                <asp:TextBox ID="txtfolio" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" BackColor="White" ControlToValidate="txtfolio" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="dir">*</asp:RequiredFieldValidator>
                            </div>
                            <div class="col-lg">
                                <label class="visually">N° PRODUCTO</label>
                                <asp:TextBox ID="txtnoproducto" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" BackColor="White" ControlToValidate="txtnoproducto" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="dir">*</asp:RequiredFieldValidator>
                            </div>
                            <div class="col-lg">
                            ...
                            <div class="col-lg">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" BackColor="White" ControlToValidate="txtdetalle" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="dir">*</asp:RequiredFieldValidator>
                            </div>
                        ...
                        <div class="row gap-1" style="align-items: center; margin: 10px;">
                            <div class="col-lg">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" BackColor="White" ControlToValidate="txtunidad" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="dir">*</asp:RequiredFieldValidator>
                            </div>
                            <div class="col-lg">
                                <label class="visually">CANTIDAD EN STOCK</label>
                                <asp:TextBox ID="txtcantidad" runat="server" TextMode="Number" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                            ...
                            <div class="col-lg">
                                <label class="visually">A PEDIR</label>
                                <asp:TextBox ID="txtpedir" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" BackColor="White" ControlToValidate="txtpedir" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="dir">*</asp:RequiredFieldValidator>
                            </div>
                        </div>

                        <div class="row gap-1" style="align-items: center; margin: 10px;">
                            <div class="col-lg">
                                <label class="visually">MOTIVO</label>
                                <asp:TextBox ID="txtmotivo" runat="server" TextMode="MultiLine" CssClass="form-control" ></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" BackColor="White" ControlToValidate="txtmotivo" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="dir">*</asp:RequiredFieldValidator>
                            </div>
                        </div>

                        <div class="row gap-1" style="align-items: center; margin: 10px;">
                            <div class="col-lg">
                                <asp:Button ID="btncotizar" Width="250px" runat="server" CssClass="btn btn-outline-info" Text="AGREGAR" OnClick="btncotizar_Click" />
                            </div>
                        </div>
                    </div>
                    ...
                    <asp:Panel ID="Pnl3" runat="server">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <%--<div id="div3" class="scroll">--%>
                                    <%--<asp:GridView ID="gridreq" Width="100%" runat="server" DataKeyNames="id_producto" AutoGenerateColumns="False" GridLines="Horizontal" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" PageSize="7" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" OnSelectedIndexChanged="GridProductos_SelectedIndexChanged">--%>
                                    <asp:GridView ID="gridreq" Width="100%" runat="server" CssClass="mGrid" DataKeyNames="id_producto" AutoGenerateColumns="False" OnSelectedIndexChanged="GridProductos_SelectedIndexChanged">
                                ...
                                <br />
                                <div class="col-lg">
                                    <asp:LinkButton ID="btnguardar" Font-Size="Medium" runat="server" CssClass="btn btn-warning" OnClick="btnguardar_Click"><i class="glyphicon glyphicon-search"></i>GUARDAR</asp:LinkButton>
                                </div>
