        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            using (StringWriter sw = new StringWriter())
            {
...

                {
                    ...
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("NOMBRE DEL PACIENTE: ______________________________TEMPERATURA: PTE. _________ FAM.___________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("FECHA DE NACIMIENTO: ________________ EDAD: ________ SEXO: ________ PESO: ________ TALLA: ________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("DOMICILIO: ________________________________________________________________________ C.P. __________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("OCUPACIÓN: ____________________________________________________ TEL. PACIENTE: __________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("TEL. FAMILIAR: __________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("FECHA DE INGRESO: __________________________ FECHA DE EGRESO: _____________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("HORA DE INGRESO: ___________________________ HORA DE EGRESO: ______________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("DX. INGRESO ____________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb1.AddCell(new PdfPCell(new Phrase("________________________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("ESTUDIOS REALIZADOS: __________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("ALERGIAS: _____________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("OBSERVACIONES: _______________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("________________________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb1.AddCell(new PdfPCell(new Phrase("__________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb2.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase("Toluca, Méx., a ________ de __________________ de ________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb3.AddCell(new PdfPCell(new Phrase("Toluca, Méx., a ________ de __________________ de 202______", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase("NOMBRE DEL PACIENTE: ________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase("Nombre del representante legal ____________________________________________ PARENTESCO ___________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase("Bajo protesta de decir verdad, declaro que el Dr.:________________________________________________ me ha explicado", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase("que mi diagnóstico es:____________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase("Y que por tal motivo debo someterme al (los) siguiente(s) con fines diagnósticos y/o terapéuticos: ________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase("______________________________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase("______________________________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb3.AddCell(new PdfPCell(new Phrase("______________________________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase("El pronóstico es: _______________________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb3.AddCell(new PdfPCell(new Phrase(".", espacio2)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb3.AddCell(new PdfPCell(new Phrase("Del mismo modo designo a: _______________________________________________________________________________", parrafo)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb6.AddCell(new PdfPCell(new Phrase(".", espacio)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb6.AddCell(new PdfPCell(new Phrase(".", espacio)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb6.AddCell(new PdfPCell(new Phrase(".", espacio)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb6.AddCell(new PdfPCell(new Phrase(".", espacio)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb6.AddCell(new PdfPCell(new Phrase("NOMBRE COMPLETO DEL PACIENTE: \n\n\n\n\n", parrafo)) { Colspan = 5, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    var cell = new PdfPCell(new Phrase("NOMBRE COMPLETO DEL RESPONSABLE DEL PACIENTE:", parrafo)) { Border = 0, Rowspan = 3, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_TOP };
                    ...
                    tb9.AddCell(new PdfPCell(new Phrase("  NOMBRE DEL PACIENTE \n\n  _____________________________________\n\n SEXO: F:_____ M:_____      EDAD: _______años", parrafo)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb9.AddCell(new PdfPCell(new Phrase("  FECHA:", parrafo2)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb9.AddCell(new PdfPCell(new Phrase("     CAMA:", parrafo2)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb10.AddCell(new PdfPCell(new Phrase("ANESTESIÓLOGO", parrafo3)) { Colspan = 19, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb10.AddCell(new PdfPCell(new Phrase("CIRUJANO", parrafo3)) { Colspan = 20, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb13.AddCell(new PdfPCell(new Phrase("Fecha de Nacimiento", parrafo3)) { Colspan = 2, HorizontalAlignment = Element.ALIGN_LEFT });
                    tb13.AddCell(new PdfPCell(new Phrase("Fecha de Elaboración", parrafo3)) { Colspan = 2, HorizontalAlignment = Element.ALIGN_LEFT });

                    tb13.AddCell(new PdfPCell(new Phrase("Diagnóstico \n\n\n\n\n\n", parrafo3)) { Colspan = 4, HorizontalAlignment = Element.ALIGN_LEFT });
                    tb13.AddCell(new PdfPCell(new Phrase("Procedimiento Quirúrgico", parrafo3)) { Colspan = 4, HorizontalAlignment = Element.ALIGN_LEFT });
                    ...
                    tb15.AddCell(new PdfPCell(new Phrase("FECHA:", parrafo3)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb15.AddCell(new PdfPCell(new Phrase("CIRUJANO:", parrafo3)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb15.AddCell(new PdfPCell(new Phrase("CIRUGÍA:", parrafo3)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb15.AddCell(new PdfPCell(new Phrase("ENF. INSTRUMENTISTA:", parrafo3)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb15.AddCell(new PdfPCell(new Phrase("PACIENTE:", parrafo3)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb15.AddCell(new PdfPCell(new Phrase("ENF. CIRCULANTE:", parrafo3)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            using (StringWriter sw = new StringWriter())
            {
...

                {
                    ...
                    tb2.AddCell(new PdfPCell(new Phrase("FECHA: _____________________________________________________", parrafo3)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb2.AddCell(new PdfPCell(new Phrase("NOMBRE: _____________________________________________", parrafo3)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase("A. PRE-OPERATORIO: ________________________________________", parrafo3)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase("______________________________________________________", parrafo3)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tb2.AddCell(new PdfPCell(new Phrase(".", espacio)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                    tb2.AddCell(new PdfPCell(new Phrase("EDAD: ___________ SEXO: ___________", parrafo3)) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
